		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-person-check"></i><span>Tài Khoản</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
				<ul id="charts-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="admincustomer"> <i class="bi bi-circle"></i><span>Danh
								Sách</span>
					</a></li>
					<li><a href="formtaikhoan.jsp"> <i class="bi bi-circle"></i><span>Thêm</span>
					</a></li>
				</ul></li>
			<!-- End Charts Nav -->
			...
			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-clipboard-check"></i><span>Giỏ Hàng</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
				<ul id="icons-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="tbltintuc.html"> <i class="bi bi-circle"></i><span>Danh
								Sách</span>
					</a></li>
					<li><a href="formtintuc.html"> <i class="bi bi-circle"></i><span>Biểu
								Đồ</span>
					</a></li>
				</ul></li>
			<!-- End Icons Nav -->
			...
			<li class="nav-item"><a class="nav-link "
				data-bs-target="#ds-nav" data-bs-toggle="collapse" href="#"> <i
					class="bi bi-bag-check"></i><span>Đơn Hàng</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
				<ul id="ds-nav" class="nav-content collapse show"
					data-bs-parent="#sidebar-nav">
					<li><a href="adminỏder" class="active"> <i
							class="bi bi-circle"></i><span>Danh Sách</span>
					</a></li>
					<li><a href="ChartOrder.jsp"> <i class="bi bi-circle"></i><span>Biểu
								Đồ</span>
					</a></li>
				</ul></li>
			<!-- End Icons Nav -->
					...
					<div class="card">
						<div class="card-body">
							...
							<p style="text-align: center;">
								Order ID: <strong><%=request.getAttribute("orderId")%></strong>
							</p>
							...
							<table class="table table-striped">
								...
								<tbody>
									<%
									double tongTien = 0;
									ArrayList<Object[]> orderDetails = (ArrayList<Object[]>) request.getAttribute("orderDetails");
									...
									<tr>
										...
										<td><%=item[4]%></td>
										<td><%=item[6]%></td>
										<!-- Corrected to item[6] for TotalAmount -->
									</tr>
									<%
