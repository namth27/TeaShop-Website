...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index_admin.jsp" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">TeaShop</span>
      </a>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index_admin.jsp">Trang chủ</a></li>
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Doanh thu <span>| Theo Tháng</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Khách Hàng <span>| Theo Tuần</span></h5>
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Sản phẩm bán chạy <span>| Hôm nay</span></h5>
        ...
        <div class="col-lg-4">
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                   Nguyễn Thành Nam <a href="#" class="fw-bold text-dark">Phản hồi khách</a> hàng
                  </div>
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Nguyễn Thành Nam <a href="#" class="fw-bold text-dark">Phản hồi khách hàng</a>
                  </div>
                </div><!-- End activity item-->
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Báo Cáo Ngân Sách <span>| Theo Tuần</span></h5>
