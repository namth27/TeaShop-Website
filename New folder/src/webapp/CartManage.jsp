					...
					<div class="card">
						<div class="card-body">
							...
							<table class="table datatable">
								...
								<tbody>
									<%
									List<Object[]> list_cart = (List<Object[]>) request.getAttribute("list_cart");
									if (list_cart != null) {
										for (Object[] cart : list_cart) {
									%>
									<tr>
										<td><%=cart[0]%></td>
										<td><%=cart[1]%></td>
										<td><%=new java.text.SimpleDateFormat("dd/MM/yyyy").format(cart[2])%></td>
										<td><%=((java.math.BigDecimal) cart[3]).setScale(0, java.math.RoundingMode.FLOOR) + " VNĐ"%></td>
										<td>
											<div style="display: flex; gap: 5px;">
												...
												<form action="admincart" method="post"
													...
													<input type="hidden" name="customerId" value="<%=cart[0]%>">
										...
										<script>
											function confirmDelete() {
												return confirm("Bạn có chắc chắn muốn xóa giỏ hàng này?");
											}
										</script>
									</tr>
									<%
									...
									%>
									<tr>
										<td colspan="5" style="text-align: center;">Không có dữ
											liệu</td>
									</tr>
									<%
									}
