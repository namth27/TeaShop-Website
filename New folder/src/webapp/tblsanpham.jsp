                    ...
                    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="components-badges.html">
                                <i class="bi bi-circle"></i><span>Khuyến Mại</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul id="forms-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="forms-elements.html" class="active">
                                <i class="bi bi-circle"></i><span>Shopee</span>
                            </a>
                        </li>
                        <li>
                            <a href="forms-layouts.html">
                                <i class="bi bi-circle"></i><span>TikTok</span>
                            </a>
                        </li>
                        <li>
                            <a href="forms-editors.html">
                                <i class="bi bi-circle"></i><span>Lazada</span>
                            </a>
                        </li>
                        <li>
                            <a href="forms-validation.html">
                                <i class="bi bi-circle"></i><span>Amazon</span>
                            </a>
                        </li>
                    </ul>
                </li><!-- End Forms Nav -->
            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" style="text-align: center;"><strong>DANH SÁCH SẢN PHẨM</strong></h5>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        <%
                                        ArrayList<ProductObject> listproduct = (ArrayList<ProductObject>) request.getAttribute("list_product");
                                        if (listproduct != null) {
                                            for (ProductObject product : listproduct) {
                                        %>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="adminproduct" method="post" style="display:inline;">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btn-sm text-white" style="margin-right: 10px;">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </button>
                                                </form>
                                                <!-- Nút xóa -->
                                                <button type="button" class="btn btn-danger btn-sm text-white" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal<%= product.getProductID() %>"><i class="bi bi-trash3"></i></button>
                                            </td>

                                            <!-- Modal xác nhận -->
                                    <div class="modal fade" id="confirmDeleteModal<%= product.getProductID() %>" tabindex="-1" aria-labelledby="confirmDeleteModalLabel<%= product.getProductID() %>" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="confirmDeleteModalLabel<%= product.getProductID() %>">Xác nhận xóa</h5>
